...
export function FloatingChatbot() {
  ...
  const handleSend = async (text: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: "Unable to connect. Please try again.", refused: true, refusedMsg: "Unable to connect to Gita wisdom. Please try again." },
      ]);
    } finally {
      setIsLoading(false);
    }
